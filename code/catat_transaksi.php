...
<body class="bg-main">
                        ...
                        <div class="card-transaksi-blue d-flex flex-column justify-content-between">
                            <div>
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-sm bg-white border me-1 shadow-sm" id="btnPrevMonth" style="border-radius: 8px;">
                                            <i class="bi bi-chevron-left"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm bg-white border shadow-sm" id="btnNextMonth" style="border-radius: 8px;">
    ...
    <nav class="mobile-bottom-nav d-md-none">
        ...
        <a href="catat_transaksi.php" class="nav-item-mobile active" style="transform: translateY(-10px);">
