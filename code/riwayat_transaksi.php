...
<body class="bg-main">
    ...
    <div class="d-flex vh-100 overflow-hidden">
        ...
        <main class="flex-grow-1 d-flex flex-column overflow-y-auto">
            ...
            <div class="p-4 p-md-5 mx-auto" style="max-width: 1100px; width: 100%;">
               ...
               <!-- KARTU UTAMA: SISA ARUS KAS (DI ATAS) -->
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="card-summary d-flex align-items-center justify-content-between p-4">
                            <div>
                                <span class="text-secondary-custom small fw-semibold d-block mb-1">Sisa Arus Kas Bulan Ini</span>
                                <h3 class="fw-bold text-dark-custom mb-0">Rp <?= number_format($ringkasan['selisih'], 0, '', '.'); ?></h3>
                            </div>
                ...
                <!-- ROW 2: PEMASUKAN & PENGELUARAN (SAMPING-SAMPINGAN) -->
                ...
                <div>
                    <?php if (empty($transaksi)): ?>
                        <div class="text-center py-5 empty-card-custom rounded-4 border p-4 shadow-sm">
                            ...
                            <a href="catat_transaksi.php" class="btn btn-primary-custom px-4 py-2 rounded-pill fw-bold small">
                                <i class="bi bi-plus-lg me-1"></i> Catat Transaksi Sekarang
                            </a>
                        </div>
                    <?php else: ?>
    ...
    <nav class="mobile-bottom-nav d-md-none">
        ...
        <a href="riwayat_transaksi.php" class="nav-item-mobile active">
            <i class="bi bi-clock-history"></i><span>Riwayat</span>
        </a>
        <a href="analisa.php" class="nav-item-mobile">
            <i class="bi bi-pie-chart-fill"></i><span>Analisa</span>
        </a>
    </nav>
